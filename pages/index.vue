    ...
    <div class="container m-auto max-w-none sm:max-w-md h-screen sm:h-auto bg-white rounded-none sm:rounded-lg shadow">
      <div class="px-6 flex flex-col">
        ...
        <form class="py-8 space-y-2">
          ...
          <div class="space-y-2">
            <button @click.prevent="onLogin" class="text-sm font-medium w-full bg-green-500 py-2 border-none text-white rounded hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 uppercase on ease-in-out duration-200">
              Login
            </button>
